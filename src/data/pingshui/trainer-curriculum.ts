...
export const RHYMES_PINGSHENG: Rhyme[] = [
...

  {
    ...
    modernRime: '-ong',
    seedCharacters: [
      { char: '冬', pinyin: 'dōng', jyutping: 'dung1', set: 1 },
      { char: '钟', pinyin: 'zhōng', jyutping: 'zung1', set: 1 },
      { char: '松', pinyin: 'sōng', jyutping: 'cung4', set: 1 },
      { char: '峰', pinyin: 'fēng', jyutping: 'fung1', set: 1 },
      { char: '封', pinyin: 'fēng', jyutping: 'fung1', set: 1 },
      { char: '龙', pinyin: 'lóng', jyutping: 'lung4', set: 1 },
      { char: '容', pinyin: 'róng', jyutping: 'jung4', set: 1 },
      { char: '重', pinyin: 'chóng', jyutping: 'cung4', set: 1 },
      { char: '浓', pinyin: 'nóng', jyutping: 'nung4', set: 1 },
      { char: '从', pinyin: 'cóng', jyutping: 'cung4', set: 1 },
      { char: '农', pinyin: 'nóng', jyutping: 'nung4', set: 1 },
      { char: '宗', pinyin: 'zōng', jyutping: 'zung1', set: 1 },
      { char: '庸', pinyin: 'yōng', jyutping: 'jung4', set: 2 },
      { char: '凶', pinyin: 'xiōng', jyutping: 'hung1', set: 2 },
      { char: '胸', pinyin: 'xiōng', jyutping: 'hung1', set: 2 },
      { char: '蜂', pinyin: 'fēng', jyutping: 'fung1', set: 2 },
      { char: '锋', pinyin: 'fēng', jyutping: 'fung1', set: 2 },
      { char: '蓉', pinyin: 'róng', jyutping: 'jung4', set: 2 },
      { char: '锺', pinyin: 'zhōng', jyutping: 'zung1', set: 2 },
      { char: '鏞', pinyin: 'yōng', jyutping: 'jung4', set: 2 },
      { char: '蛩', pinyin: 'qióng', jyutping: 'kung4', set: 3 },
      { char: '邛', pinyin: 'qióng', jyutping: 'kung4', set: 3 },
      { char: '慵', pinyin: 'yōng', jyutping: 'jung4', set: 3 },
      { char: '舂', pinyin: 'chōng', jyutping: 'cung1', set: 3 },
      { char: '雍', pinyin: 'yōng', jyutping: 'jung1', set: 3 },
      { char: '痈', pinyin: 'yōng', jyutping: 'jung1', set: 3 },
      { char: '邕', pinyin: 'yōng', jyutping: 'jung1', set: 4 },
      { char: '纵', pinyin: 'zòng', jyutping: 'zung3', set: 4 },
      { char: '喁', pinyin: 'yóng', jyutping: 'jung4', set: 4 },
      { char: '跫', pinyin: 'qióng', jyutping: 'kung4', set: 4 },
    ],
    mnemonic:

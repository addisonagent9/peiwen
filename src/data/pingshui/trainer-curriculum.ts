...
export const RHYMES_PINGSHENG: Rhyme[] = [
...

  {
    ...
    seedCharacters: [
      { char: '东', pinyin: 'dōng', jyutping: 'dung1' },
      { char: '风', pinyin: 'fēng', jyutping: 'fung1' },
      { char: '空', pinyin: 'kōng', jyutping: 'hung1' },
      { char: '中', pinyin: 'zhōng', jyutping: 'zung1' },
      { char: '红', pinyin: 'hóng', jyutping: 'hung4' },
      { char: '同', pinyin: 'tóng', jyutping: 'tung4' },
      { char: '通', pinyin: 'tōng', jyutping: 'tung1' },
      { char: '翁', pinyin: 'wēng', jyutping: 'jung1', showMandarinAudio: true },
      { char: '弓', pinyin: 'gōng', jyutping: 'gung1' },
      { char: '宫', pinyin: 'gōng', jyutping: 'gung1' },
      { char: '功', pinyin: 'gōng', jyutping: 'gung1' },
      { char: '虹', pinyin: 'hóng', jyutping: 'hung4', showMandarinAudio: true },
    ],
    mnemonic:
...

  {
    ...
    modernRime: '-ang',
    seedCharacters: [
      { char: '阳', pinyin: 'yáng', jyutping: 'joeng4' },
      { char: '光', pinyin: 'guāng', jyutping: 'gwong1' },
      { char: '霜', pinyin: 'shuāng', jyutping: 'soeng1' },
      { char: '乡', pinyin: 'xiāng', jyutping: 'hoeng1' },
      { char: '香', pinyin: 'xiāng', jyutping: 'hoeng1' },
      { char: '长', pinyin: 'cháng', jyutping: 'coeng4' },
      { char: '常', pinyin: 'cháng', jyutping: 'soeng4' },
      { char: '场', pinyin: 'chǎng', jyutping: 'coeng4' },
      { char: '章', pinyin: 'zhāng', jyutping: 'zoeng1' },
      { char: '羊', pinyin: 'yáng', jyutping: 'joeng4' },
      { char: '方', pinyin: 'fāng', jyutping: 'fong1' },
      { char: '凉', pinyin: 'liáng', jyutping: 'loeng4' },
    ],
    mnemonic:
...

  {
    ...
    modernRime: '-ou / -iu',
    seedCharacters: [
      { char: '尤', pinyin: 'yóu', jyutping: 'jau4' },
      { char: '忧', pinyin: 'yōu', jyutping: 'jau1' },
      { char: '秋', pinyin: 'qiū', jyutping: 'cau1' },
      { char: '楼', pinyin: 'lóu', jyutping: 'lau4' },
      { char: '流', pinyin: 'liú', jyutping: 'lau4' },
      { char: '舟', pinyin: 'zhōu', jyutping: 'zau1' },
      { char: '留', pinyin: 'liú', jyutping: 'lau4' },
      { char: '收', pinyin: 'shōu', jyutping: 'sau1' },
      { char: '头', pinyin: 'tóu', jyutping: 'tau4' },
      { char: '愁', pinyin: 'chóu', jyutping: 'sau4' },
      { char: '游', pinyin: 'yóu', jyutping: 'jau4' },
      { char: '州', pinyin: 'zhōu', jyutping: 'zau1' },
    ],
    mnemonic:
...

  {
    ...
    modernRime: '-a / -ia / -ua',
    seedCharacters: [
      { char: '麻', pinyin: 'má', jyutping: 'maa4' },
      { char: '家', pinyin: 'jiā', jyutping: 'gaa1' },
      { char: '花', pinyin: 'huā', jyutping: 'faa1' },
      { char: '霞', pinyin: 'xiá', jyutping: 'haa4' },
      { char: '华', pinyin: 'huá', jyutping: 'waa4' },
      { char: '沙', pinyin: 'shā', jyutping: 'saa1' },
      { char: '斜', pinyin: 'xié', jyutping: 'ce4' },
      { char: '茶', pinyin: 'chá', jyutping: 'caa4' },
      { char: '涯', pinyin: 'yá', jyutping: 'ngaai4', showMandarinAudio: true },
      { char: '鸦', pinyin: 'yā', jyutping: 'aa1', showMandarinAudio: true },
      { char: '加', pinyin: 'jiā', jyutping: 'gaa1' },
      { char: '瓜', pinyin: 'guā', jyutping: 'gwaa1' },
    ],
    mnemonic:
...

  {
    ...
    modernRime: '-e / -o / -uo',
    seedCharacters: [
      { char: '歌', pinyin: 'gē', jyutping: 'go1' },
      { char: '多', pinyin: 'duō', jyutping: 'do1' },
      { char: '何', pinyin: 'hé', jyutping: 'ho4' },
      { char: '河', pinyin: 'hé', jyutping: 'ho4' },
      { char: '过', pinyin: 'guò', jyutping: 'gwo3' },
      { char: '波', pinyin: 'bō', jyutping: 'bo1' },
      { char: '磨', pinyin: 'mó', jyutping: 'mo4', showMandarinAudio: true },
      { char: '罗', pinyin: 'luó', jyutping: 'lo4', showMandarinAudio: true },
      { char: '娥', pinyin: 'é', jyutping: 'ngo4', showMandarinAudio: true },
      { char: '蛾', pinyin: 'é', jyutping: 'ngo4', showMandarinAudio: true },
      { char: '哥', pinyin: 'gē', jyutping: 'go1' },
      { char: '柯', pinyin: 'kē', jyutping: 'o1', showMandarinAudio: true },
    ],
    mnemonic:

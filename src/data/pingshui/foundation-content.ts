...
export const FOUNDATION_SCREENS: FoundationScreen[] = [
...

  {
    ...
    demos: [
      { text: '空', caption: '一东 韵脚字', pinyin: 'kōng', classicalTone: 'ping',
        note: '普通话 -ong,粤语 hung¹ — 两者都押 一东 韵。',
        cantoneseEvidence: { jyutping: 'hung1', descriptor: '-ung 保留' } },
      { text: '同', caption: '一东 韵脚字', pinyin: 'tóng', classicalTone: 'ping',
        note: '普通话 -ong,粤语 tung⁴ — 两者都押 一东 韵。',
        cantoneseEvidence: { jyutping: 'tung4', descriptor: '-ung 保留' } },
      { text: '翁', caption: '一东 韵脚字', pinyin: 'wēng', classicalTone: 'ping',
        note: '普通话 -eng,粤语 jung¹ — 粤语里 翁 与 空、同 押韵一致。',
        cantoneseEvidence: { jyutping: 'jung1', descriptor: '-ung 保留' } },
    ],
...

  {
    ...
    body: [
      ...
      '十一尤韵的韵脚字 流 和 楼,在粤语里读音完全相同(都读 lau⁴)!这就是一对"同音字押韵"的例子 — 一目了然。王之涣《登鹳雀楼》就是这个韵。下面听一听,先听普通话,再听粤语,注意 流 和 楼 在粤语里是不是真的一样。',
    ],
    demos: [
      { text: '流', caption: '十一尤 韵脚字', pinyin: 'liú', classicalTone: 'ping',
        note: '普通话 liú,粤语 lau⁴。',
        cantoneseEvidence: { jyutping: 'lau4', descriptor: '与 楼 同音' } },
      { text: '楼', caption: '十一尤 韵脚字', pinyin: 'lóu', classicalTone: 'ping',
        note: '普通话 lóu,粤语 lau⁴ — 粤语里 楼 与 流 完全同音。',
        cantoneseEvidence: { jyutping: 'lau4', descriptor: '与 流 同音' } },
    ],
    anchorDemo: { rhymeId: 'xiaping-11-you' },

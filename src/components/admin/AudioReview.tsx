        ...
        <div className="space-y-4">
          {items.map(item => (
            ...
            >
              ...
              {/* Clips */}
              {item.clips.length === 0 ? (
                <div className="px-4 py-4 text-sm text-[#F5F0E8]/30">No clips generated yet.</div>
              ) : (
                  ...
                  {item.clips.map(clip => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 min-w-0 flex-1">
                        ...
                        <span className="text-xs text-[#F5F0E8]/40 truncate">
                          {clip.provider}/{clip.voiceId}
                        </span>
                      ...
                      <div className="flex gap-2 flex-shrink-0">
                        <button
                          ...
                          className="px-2.5 py-1 rounded-md text-xs font-medium bg-[#B8A04A]/10 text-[#B8A04A] border border-[#B8A04A]/30 hover:bg-[#B8A04A]/20 disabled:opacity-30 transition"
                        >
                          Approve
                        </button>
                        <button
                          ...
                          className="px-2.5 py-1 rounded-md text-xs font-medium bg-rose-400/10 text-rose-400 border border-rose-400/30 hover:bg-rose-400/20 disabled:opacity-30 transition"
                        >
                          Reject
                        </button>
                        <button
                          ...
                          className="px-2.5 py-1 rounded-md text-xs font-medium bg-amber-300/10 text-amber-300 border border-amber-300/30 hover:bg-amber-300/20 disabled:opacity-30 transition"
                        >
                          Regen
                        </button>
                      </div>

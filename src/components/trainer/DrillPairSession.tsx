...
const WrongAnswerPanel: React.FC<{
  ...
  <div className="space-y-4 border border-rose-400/30 rounded-lg p-4 bg-rose-400/5">
    {/* Answer reveal */}
    <div>
      <p className="text-xs text-gold/70 font-sans mb-1">{strings.drill3CorrectAnswer}</p>
    ...
    {item.family && (
      <div>
        <p className="text-xs text-gold/70 font-sans mb-1">家族</p>
    ...
    {item.teachingNote && (item.teachingNote.left || item.teachingNote.right) && (
      <div>
        <p className="text-xs text-gold/70 font-sans mb-1">{strings.drill3TeachingNote}</p>
    ...
    {item.mnemonic && (item.mnemonic.left || item.mnemonic.right) && (
      <div>
        <p className="text-xs text-gold/70 font-sans mb-1">{strings.drill3Mnemonic}</p>
    ...
    {(item.leftAnchor || item.rightAnchor) && (
      <div>
        <p className="text-xs text-gold/70 font-sans mb-2">{strings.drill3AnchorPoem}</p>

...
export const RHYMES_PINGSHENG = [
...

  {
    ...
    seedCharacters: ['东', '风', '空', '中', '红', '同', '通', '翁', '弓', '宫', '功', '虹'],
    mnemonic:
...

  {
    ...
    modernRime: '-ang',
    seedCharacters: ['阳', '光', '霜', '乡', '香', '长', '常', '场', '章', '羊', '方', '凉'],
    mnemonic:
...

  {
    ...
    confusables: [],
    modernRime: '-ou / -iu',
    seedCharacters: ['尤', '忧', '秋', '楼', '流', '舟', '留', '收', '头', '愁', '游', '州'],
    mnemonic:
...

  {
    ...
    confusables: [],
    modernRime: '-a / -ia / -ua',
    seedCharacters: ['麻', '家', '花', '霞', '华', '沙', '斜', '茶', '涯', '鸦', '加', '瓜'],
    mnemonic:
...

  {
    ...
    confusables: [],
    modernRime: '-e / -o / -uo',
    seedCharacters: ['歌', '多', '何', '河', '过', '波', '磨', '罗', '娥', '蛾', '哥', '柯'],
    mnemonic:
...
export const findSeedRhyme = (character) =>

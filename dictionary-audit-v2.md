...
| Metric | Count |
|--------|-------|
| Our dictionary chars | 19624 |
| Consensus chars (union of 3 refs) | 19700 |
| In both | 19128 |
| Only in ours | 496 |
| Only in consensus | 572 |
...
|------|-------------|-----------|-------|
| 徘 | 平/九佳 | 平/十灰 (charles,cope) | default disagrees with consensus, not even in secondary readings |
...
| 暖 | 平/十三元, 仄/十三阮 | 仄/十四旱 (charles,cope) | default disagrees with consensus, not even in secondary readings |
...
| 濫 | 仄/二十九豏, 仄/二十八勘 | 仄/二十七感 (charles,jkak) | default disagrees with consensus, not even in secondary readings |
...
| 嚙 | 仄/十八巧 | 仄/九屑 (charles,cope) | default disagrees with consensus, not even in secondary readings |
| 臒 | 仄/十藥 | 平/七虞 (jkak,cope) | default disagrees with consensus, not even in secondary readings |
...
| Char | Issue | Details |
|------|-------|---------|
| 沖 | missing | consensus: 平/一東, 平/二冬 (charles, jkak, cope) |
...
| 貍 | missing | consensus: 平/四支 (charles, jkak, cope) |
| 彜 | missing | consensus: 平/四支 (charles, jkak, cope) |
...
| 籲 | missing | consensus: 平/七虞, 仄/七遇 (charles, jkak, cope) |
...
| 真 | missing | consensus: 平/十一真 (charles, jkak, cope) |
...
| 溫 | missing | consensus: 平/十三元 (charles, jkak, cope) |
...
| 秈 | missing | consensus: 平/一先 (charles, jkak, cope) |
...
| 窯 | missing | consensus: 平/二蕭 (charles, jkak, cope) |
...
| 臯 | missing | consensus: 平/四豪 (charles, jkak, cope) |
...
| 劃 | missing | consensus: 平/六麻, 仄/十一陌 (charles, jkak, cope) |
...
| 涼 | missing | consensus: 平/七陽 (charles, jkak, cope) |
| 床 | missing | consensus: 平/七陽 (charles, jkak, cope) |
...
| 瑯 | missing | consensus: 平/七陽 (charles, jkak, cope) |
...
| 荊 | missing | consensus: 平/八庚 (charles, jkak, cope) |
...
| 留 | missing | consensus: 平/十一尤, 仄/二十六宥 (charles, jkak, cope) |
...
| 鉤 | missing | consensus: 平/十一尤 (charles, jkak, cope) |
...
496 chars in our dictionary but not in any reference.
